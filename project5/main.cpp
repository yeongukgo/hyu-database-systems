...
void* thread1(void* args) {
    ...
    trx_id = begin_trx();
    printf("trx (%d) started\n", trx_id);
    printf("trx (%d) : update1_result : %d\n", trx_id, db_update(table_id,key1, values1,trx_id));
    sleep(3);
    printf("trx (%d) restarted\n", trx_id);
    printf("trx (%d) : update2_result : %d\n", trx_id, db_update(table_id,key2, values2,trx_id));
