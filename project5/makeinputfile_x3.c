...
/*
    for(i = 0; i < NUM; i++) { // print
        //printf("test4\n");
        printf("i 4 %d thisis%d*3\n", array[i] * 3, array[i]);
        fprintf(insert, "i 4 %d thisis%d*3\n", array[i] * 3, array[i]);
        fprintf(find, "f 4 %d\n", array[i] * 3);
    ...
    for(i = 0; i < NUM/4; i++) { // print
        ...
        printf("i 4 %d thisis%d*3\n", array[i]*3, array[i]);
        fprintf(insert, "i 4 %d thisis%d*3\n", array[i]*3, array[i]);
        fprintf(insert1, "i 4 %d thisis%d*3\n", array[i]*3, array[i]);
        fprintf(find, "f 4 %d\n", array[i]*3);
        fprintf(delete, "d 4 %d\n", array[i]*3);
    ...
    for(i = NUM/4; i < 2*(NUM/4); i++) { // print
        ...
        printf("i 4 %d thisis%d*3\n", array[i]*3, array[i]);
        fprintf(insert, "i 4 %d thisis%d*3\n", array[i]*3, array[i]);
        fprintf(insert2, "i 4 %d thisis%d*3\n", array[i]*3, array[i]);
        fprintf(find, "f 4 %d\n", array[i]*3);
        fprintf(delete, "d 4 %d\n", array[i]*3);
    ...
    for(i = 2*(NUM/4); i < 3*(NUM/4); i++) { // print
        ...
        printf("i 4 %d thisis%d*3\n", array[i]*3, array[i]);
        fprintf(insert, "i 4 %d thisis%d*3\n", array[i]*3, array[i]);
        fprintf(insert3, "i 4 %d thisis%d*3\n", array[i]*3, array[i]);
        fprintf(find, "f 4 %d\n", array[i]*3);
        fprintf(delete, "d 4 %d\n", array[i]*3);
    ...
    for(i = 3*(NUM/4); i < NUM; i++) { // print
        ...
        printf("i 4 %d thisis%d*3\n", array[i]*3, array[i]);
        fprintf(insert, "i 4 %d thisis%d*3\n", array[i]*3, array[i]);
        fprintf(insert4, "i 4 %d thisis%d*3\n", array[i]*3, array[i]);
        fprintf(find, "f 4 %d\n", array[i]*3);
        fprintf(delete, "d 4 %d\n", array[i]*3);
